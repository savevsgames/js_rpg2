...
export default class MainGameScene extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		text_1.setStyle({ "align": "right", "color": "#ceba96ff", "fontSize": "54px", "fontStyle": "bold", "stroke": "#000000ff", "strokeThickness":5,"shadow.offsetX":13,"shadow.offsetY":8,"shadow.blur":5,"shadow.fill":true});
